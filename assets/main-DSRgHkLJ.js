...
`,E=f`
    ...
    margin-top: 20px;
    margin-bottom: 40px;
`,D=()=>(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`div`,{className:T,children:`张振衣`}),(0,m.jsx)(`div`,{className:E,children:(0,m.jsx)(`a`,{className:w,href:`https://zhihu.com/people/dancerphil`,children:`https://zhihu.com/people/dancerphil`})})]}),O=f`
    padding: 8px 4px;
    display: flex;
    align-items: center;
    border-radius: 4px;
...
`,P=f`
    ...
    font-weight: 500;
    color: #159957;
`,F=({children:e})=>(0,m.jsx)(`div`,{className:P,children:e});(0,v.createRoot)(document.body).render((0,m.jsx)(u,{children:(0,m.jsx)(()=>(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(C,{children:(0,m.jsx)(D,{})}),(0,m.jsxs)(`div`,{className:M,children:[(0,m.jsx)(F,{children:`关于我`}),(0,m.jsx)(j,{href:`https://github.com/dancerphil`,title:`我的 github 主页`}),(0,m.jsx)(_,{my:`lg`}),(0,m.jsx)(F,{children:`推荐`}),(0,m.jsx)(j,{href:`https://agents.dancerphil.com`,title:`股票分析`,description:`多智能体股票分析工作流`}),(0,m.jsx)(j,{href:`./tlp`,title:`《逻辑哲学论》`,description:`维特根斯坦的哲学著作，包含了 AI 辅读`}),(0,m.jsx)(j,{href:`https://github.com/regionjs/region`,title:`region-react`,description:`react 状态管理`}),(0,m.jsx)(j,{href:`https://github.com/dancerphil/dancerphil.github.io`,title:`dancerphil.github.io`,description:`当前站点的源码`}),(0,m.jsx)(_,{my:`lg`}),(0,m.jsx)(F,{children:`随手写的玩具`}),(0,m.jsx)(j,{href:`./age`,title:`age`,description:`可以计算自己的年龄的工具，精确到 0.0000001`}),(0,m.jsx)(j,{href:`./annotate`,title:`annotate`,description:`数据标记产品原型`}),(0,m.jsx)(j,{href:`./async-await-cookbook`,title:`async-await-cookbook`,description:`async await 代码风格指南`}),(0,m.jsx)(j,{href:`./cash-flow`,title:`现金流计算器`,description:`计算一笔现金流资产值多少钱`}),(0,m.jsx)(j,{href:`./capital`,title:`资本视图`,description:`用 echarts 桑基图可视化资产配置结构`}),(0,m.jsx)(j,{href:`./color`,title:`颜色计算器`,description:`计算一个颜色在透明模式下的色值`}),(0,m.jsx)(j,{href:`./compact`,title:`compact`,description:`移除样式、保留结构和值的 HTML 清理器`}),(0,m.jsx)(j,{href:`./coder`,title:`coder`,description:`基于 localStorage 的在线的编辑器（代码很老）`}),(0,m.jsx)(j,{href:`./github-friends`,title:`github 关系网`,description:`用 echarts 关系图分析 github 关系，可以找朋友`}),(0,m.jsx)(j,{href:`./mbti`,title:`mbti`,description:`一个mbti八维分析工具`}),(0,m.jsx)(j,{href:`./mine`,title:`扫雷`,description:`适配手机端的扫雷游戏`}),(0,m.jsx)(_,{my:`lg`}),(0,m.jsx)(F,{children:`随手写的动画`}),(0,m.jsx)(j,{href:`./10/once.html`,title:`10 随机迷宫`}),(0,m.jsx)(j,{href:`./b`,title:`base64 背景图`}),(0,m.jsx)(j,{href:`https://codepen.io/dancerphil/pen/POdeWy`,title:`纯 css 动画：bees`}),(0,m.jsx)(j,{href:`./d`,title:`任务管理`}),(0,m.jsx)(j,{href:`https://codepen.io/dancerphil/pen/dRmLza`,title:`自动旋转的画图工具`}),(0,m.jsx)(j,{href:`./m`,title:`material-design v0 颜色分析`}),(0,m.jsx)(j,{href:`./w`,title:`纯 css 动画`}),(0,m.jsx)(_,{my:`lg`}),(0,m.jsxs)(`div`,{className:N,children:[`With Love. `,(0,m.jsx)(`a`,{target:`_blank`,href:`https://github.com/dancerphil`,rel:`noreferrer`,children:`Dancerphil`})]})]})]}),{})}));